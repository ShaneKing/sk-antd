...
export default class FormComp extends Comp {
  ...
  render() {
    ...
    let help = _.isEmpty(errorObj) ? '' : _.join(errorObj.skVals(), SK.CHAR_VERTICAL);
    let validateStatus = _.isEmpty(errorObj) ? '' : 'error';
